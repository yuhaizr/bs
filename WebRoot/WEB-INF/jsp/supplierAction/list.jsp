...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 供应商管理
        </div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <thead>
            <tr align="CENTER" valign="MIDDLE" id="TableTitle">
				<th>供应商编号</th>
		<th>名称</th><th>联系人</th><th>联系电话</th><th>地址</th><th>说明</th><th>相关操作</th></tr>
    ...
    <div id="TableTail">
		<div id="TableTail_inside">
			<s:a action="supplierAction_addUI"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></s:a>
        </div>
    </div>
