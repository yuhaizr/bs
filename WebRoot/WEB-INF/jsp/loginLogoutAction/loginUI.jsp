...
<!-- 显示表单 -->
<s:form action="loginLogoutAction_login" focusElement="loginNameInput">
    <div id="CenterAreaBg"> 
        <div id="CenterArea">
        <s:fielderror cssStyle="color:red;"></s:fielderror>
            ...
            <div id="CopyRight"><a href="javascript:void(0)">&copy; 2015 版权所有 舟山石油</a></div>
        </div>
    </div>
    </s:form>
</body>
