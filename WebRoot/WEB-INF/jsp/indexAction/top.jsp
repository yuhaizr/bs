...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">基于进销存的管理系统</font> 
		...
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup">
            	<a href="${pageContext.request.contextPath}/personAction_list.action" target="right">
        ...
        <div id="Head1Right_SystemButton">
            <a href="${pageContext.request.contextPath}/loginLogoutAction_logout.action" target="_parent">
